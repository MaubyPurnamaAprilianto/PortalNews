...
@endif
<a href="/profile" class="btn btn-primary btn-lg my-5">Edit
Profile</a>
<div class="row mx-0">
<div class="col-4">
@if ($profile->photo_profile)
<img src="{{asset('/uploads/profile/' .
$profile->photo_profile)}}" class="rounded-circle" alt="Cinque
...
@empty
<li class="">belum ada berita yang
dikomentari</li>
@endforelse
</ul>
@else
<img src="https://dummyimage.com/480x320/000/fff"
class="rounded-circle" alt="Cinque Terre" width="304"
height="236">
@endif
</div><div class="col-8">
