...
<div><div class="fh5co_heading
  ...
  src="{{asset('/uploads/'.$item->thumbnail)}}" alt=""/></div>
  <div></div>
  </div>
  </div>
  <div class="col-md-7 animate-box">
  <a href="/news/detail/{{$item->id}}"
  class="fh5co_magna py-2"> {{$item->title}} </a>
  ...
  fh5co_heading_border_bottom py-2 mb-4">Kategory</div></div>
